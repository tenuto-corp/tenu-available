    ...
    >
      {hours(timeConvention).map(hour => (
        <div
          ...
          style={{ height: HOUR_IN_PIXELS,backgroundColor:"#fafafa" }}
        >
          <div style={{backgroundColor:"#fafafa",fontWight:"bold",fontSize:"12px",marginRight:"-2px"}} className={styles.inner}>
